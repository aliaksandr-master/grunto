...
GruntO.prototype = {
	...
	module: function (targetPrefixString, moduleFunctionOrPathToModule) {
		...
		var moduleFunction = _.isString(moduleFunctionOrPathToModule) ? require(path.resolve(process.cwd(), moduleFunctionOrPathToModule)) : moduleFunctionOrPathToModule; // eslint-disable-line
	...
	addConfig: function addConfig (config) {
		...
		_.each(config, function (v, k) {
			that._config[k] = that._config.hasOwnProperty(k) ? _.extend(that._config[k], v) : v;
		});
