...
module.exports = function (grunt) {
	...
	return {
		...
		register: function (name) {
			var RUNNER_NAME = 'RUN_' + name;

			if (!registered[name]) {
				registered[name] = [RUNNER_NAME];
			}

			GruntOModuleContext.prototype[RUNNER_NAME] = function (targetName, config) {
			...
			if (GruntOModuleContext.prototype[name] == null) {
				...
				GruntOModuleContext.prototype[name] = GruntOModuleContext.prototype[RUNNER_NAME];
			}
		},
