 ...
 * */
var Context = function (grunt, aliases, refsObj, config, prefix, context) {
...
Context.prototype = {
	...
	$run: function (tasks) {
		...
		_.each(tasks, function (task) {
			task = /^\./.test(task) ? path.normalize(path.join(this.CURRENT_PREFIX, task)) : task;
	 ...
	 * @returns {Context} this
	 * */
	$task: function (name, targetName, callback) {
